...
export default class WhipCoral extends MyObject {
    static PARAMS = {
        // L-System Settings
        iteration: 5,
    ...
    static NAME = "WhipCoral";

    static getParams() {
        return WhipCoral.PARAMS;
    }
    ...
    constructor(
        ...
        iteration = WhipCoral.PARAMS.iteration,
        rootThickness = WhipCoral.PARAMS.rootThickness,
        rootLength = WhipCoral.PARAMS.rootLength,
        branchThicknessScaler = WhipCoral.PARAMS.branchThicknessScaler,
        branchLengthScaler = WhipCoral.PARAMS.branchLengthScaler,
        branchMaxAngle = WhipCoral.PARAMS.branchMaxAngle,
        seed = WhipCoral.PARAMS.seed,
        centerOriented = WhipCoral.PARAMS.centerOriented,
        centerDegree = WhipCoral.PARAMS.centerDegree,
        curveType = WhipCoral.PARAMS.curveType
    ) {
